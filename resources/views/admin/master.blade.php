                                ...
                                <div class="d-flex order-lg-2">
                                    ...
                                    <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                        <a class="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
                                            <img class="header-icons language" alt="" src="{{asset('/')}}admin-assets/assets/images/flags/bangladesh.png">
                                        </a>
                                    </div>
                                    <!-- SEARCH -->
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('subcategory.add')}}" class="slide-item">Add Sub Category</a></li>
                                <li><a href="{{route('subcategory.manage')}}" class="slide-item">Manage Sub Category</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('product.manage')}}" class="slide-item">Manage Product</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('order.add')}}" class="slide-item">Add Order</a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="treeview.html" class="slide-item">Add Customer</a></li>
